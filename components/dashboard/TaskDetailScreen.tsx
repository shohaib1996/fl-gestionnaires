...
export default function TaskDetailScreen({
  ...
  return (
    <div
      className="w-full flex flex-col relative bg-[#63A053]"
      style={{ height: "calc(var(--vh, 1vh) * 100)" }}
    >
      {/* ---------------- TOP GREEN AREA ---------------- */}
      <div className="flex-1 flex flex-col items-center pt-24 px-6 relative z-10 text-white">
        {/* Back Button */}
        <button
          onClick={onBack}
          className="absolute left-6 top-8 p-2 -ml-2 hover:bg-white/10 rounded-full transition-colors"
          aria-label="Retour"
        >
        ...
        {/* Title + subtitle */}
        <div className="text-center mt-12 mb-8 max-w-xs">
          <h3 className="text-2xl font-semibold leading-tight mb-2">{title}</h3>
          {subtitle && (
            <div className="text-lg opacity-90 font-light">{subtitle}</div>
          )}
        </div>
        ...
        <div className="flex items-center gap-4 mb-12">
          ...
          <div className="text-left">
            <div className="text-lg opacity-90 mb-0.5">{dateLabel}</div>
      ...
      <div className="bg-white dark:bg-[#1e1e1e] w-full rounded-t-[40px] px-6 py-8 relative z-20 flex flex-col items-center text-center min-h-[55%] transition-colors duration-300">
        ...
        {/* Avatars row */}
        <div className="flex items-center justify-center gap-3 mb-8 w-full flex-wrap">
          {participants.map((p) => (
            <div
              key={p.id}
