...
export const Stepper: React.FC<StepperProps> = ({ currentStep }) => {
  if (currentStep === 4) return null; // Hide stepper on confirmation page
  return (
    <div className="w-full py-8 mb-8">
      <div className="relative flex items-center w-full">
        {/* Background Line */}
        <div className="absolute top-[calc(100%-6px)] md:top-[calc(100%-8px)] left-[12.5%] right-[12.5%] transform -translate-y-1/2 h-0.5 bg-gray-300 z-10" />

        {/* Active Line */}
        <div
          className="absolute top-[calc(100%-6px)] md:top-[calc(100%-8px)] left-[12.5%] transform -translate-y-1/2 h-0.5 bg-[#5F9E50] z-10 transition-all duration-300"
          style={{
            width: `calc((100% - 25%) * ${
