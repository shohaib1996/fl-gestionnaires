      ...
      <div className="space-y-8">
        <div className="space-y-2">
          ...
          <Input
            ...
            className="bg-[#F0F4F4] border-none rounded-xs h-12 text-xl md:text-base placeholder:text-gray-400"
          />
        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-3">
            {categories.map((category, index) => (
              ...
              >
                ...
                <span className="text-2xl md:text-sm text-gray-600">{category}</span>
              </label>
            ))}
          </div>
        </div>
          ...
          <div className="space-y-3">
            {phases.map((phase, index) => (
              ...
              >
                ...
                <span className="text-2xl md:text-sm text-gray-600">{phase}</span>
              </label>
            ))}
          </div>
        </div>
