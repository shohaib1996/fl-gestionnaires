          ...
          >
            {Array.from({ length: 20 }).map((_, i) => (
              <Link href={`/dashboard/12345678`} key={i}>
                <div className="relative bg-white dark:bg-neutral-800 shadow-sm flex flex-col overflow-visible rounded-sm">
                  <div className="bg-[#63A053]/25 px-4 py-2 flex justify-between">
